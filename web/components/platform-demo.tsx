    ...
    <section className="mx-auto max-w-7xl px-6 py-20 md:px-10 md:py-24">
      ...
      >
        ...
        <p className="mt-5 text-lg leading-8 text-white/68">
          Интерактивная визуализация показывает, как ANACONDA / OSNOVA собирает данные из разрозненных источников
          и преобразует их в управляемые процессы с AI-оркестрацией.
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="mt-6 text-center text-sm text-white/60">
          Схема показывает, как платформа собирает разрозненные источники в единый orchestration hub и передает
          результат в AI, аналитику и управляемые workflow.
        </div>
      </motion.div>
    </section>
  );
